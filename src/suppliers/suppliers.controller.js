...
//create() calls the suppliersService.create() method, passing in req.body.data as the argument, which references the object containing the supplier info
//chaining .then() executes the Knex query, which promise, if resolved successfully results in 201 status and newly created supplier
